...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15675 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15675(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_15677 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_15677(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_15681 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_15681(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_15685 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_15685(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15689 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15689(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15690 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15690(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__15664,callback){
var map__15665 = p__15664;
var map__15665__$1 = cljs.core.__destructure_map(map__15665);
var input = map__15665__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15665__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15665__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
