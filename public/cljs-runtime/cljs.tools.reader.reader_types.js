...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_9734 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_9734(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_9735 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_9735(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_9736 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_9736(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_9737 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_9737(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_9741 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_9741(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_9742 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_9742(reader);
}
});
...
var G__9752 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__9753 = s.append(c);
c = G__9752;
s = G__9753;
continue;
}
