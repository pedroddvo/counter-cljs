...
return [(function (){var pred__11554 = cljs.core.instance_QMARK_;
var expr__11555 = reactive_val;
if(cljs.core.truth_((pred__11554.cljs$core$IFn$_invoke$arity$2 ? pred__11554.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__11555) : pred__11554.call(null,reagent.ratom.RAtom,expr__11555)))){
return "ra";
} else {
if(cljs.core.truth_((pred__11554.cljs$core$IFn$_invoke$arity$2 ? pred__11554.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__11555) : pred__11554.call(null,reagent.ratom.RCursor,expr__11555)))){
return "rc";
} else {
if(cljs.core.truth_((pred__11554.cljs$core$IFn$_invoke$arity$2 ? pred__11554.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__11555) : pred__11554.call(null,reagent.ratom.Reaction,expr__11555)))){
return "rx";
} else {
if(cljs.core.truth_((pred__11554.cljs$core$IFn$_invoke$arity$2 ? pred__11554.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__11555) : pred__11554.call(null,reagent.ratom.Track,expr__11555)))){
return "tr";
} else {
return "other";
}
