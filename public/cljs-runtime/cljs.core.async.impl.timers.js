...
var i_10399 = (self__.level + (1));
while(true){
if((i_10399 <= (new_level + (1)))){
(update[i_10399] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_10401 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_10401[i]));
} else {
x__$2.forward.push((((i < links_10401.length))?(links_10401[i]):null));
}

if((i < links_10401.length)){
(links_10401[i] = x__$2);
} else {
links_10401.push(x__$2);
}
...
var i_10404 = (0);
while(true){
if((i_10404 <= self__.level)){
var links_10405 = (update[i_10404]).forward;
if((x__$1 === (((i_10404 < links_10405.length))?(links_10405[i_10404]):null))){
(links_10405[i_10404] = (x__$1.forward[i_10404]));

var G__10406 = (i_10404 + (1));
i_10404 = G__10406;
continue;
} else {
var G__10407 = (i_10404 + (1));
i_10404 = G__10407;
continue;
}
} else {
...
var G__10409 = nx;
var G__10410 = (level__$1 - (1));
x = G__10409;
level__$1 = G__10410;
continue;
} else {
var G__10411 = x;
var G__10412 = (level__$1 - (1));
x = G__10411;
level__$1 = G__10412;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__10417 = nx;
var G__10418 = (level__$1 - (1));
x = G__10417;
level__$1 = G__10418;
continue;
} else {
var G__10419 = x;
var G__10420 = (level__$1 - (1));
x = G__10419;
level__$1 = G__10420;
continue;
}
